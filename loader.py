...
from data.database import Links, Users, Subjects, Groups, AllGroups, Teachers, AllTeachers, Notify, Display, DisplayNew, Marks, SubjectsInfo
...
marks = Marks(file)
subjects_info = SubjectsInfo(file)
db.check_file()
links.check_file()
subjects.check_file()
groups.check_file()
